...
import type { EvidenceItem, EvaluationOutput, EvaluationRequest } from './evaluation-types.ts'
...
/**
 * Build a fixed-format decisionTrace. Order of lines is fixed; content is derived
 * only from the normalized evidence and the matched rule. No timestamps, addresses,
...
export function evaluateCriterion(request: EvaluationRequest): EvaluationOutput {
